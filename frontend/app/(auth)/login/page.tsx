  ...
  return (
    ...
    >
      <div className="text-center lg:text-left">
        ...
        <p className="text-gray-400 mt-2">Sign in to your AICaffe account</p>
      </div>
      ...
      {process.env.NEXT_PUBLIC_ENABLE_OAUTH === 'true' && (
        <>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white font-medium hover:bg-gray-700 transition-colors"
            >
